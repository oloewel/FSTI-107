...
a1_1 = max(0, z1_1)</div>`.replace(/,/g, ',').replace(/(\d),(\d)/g, '$1.$2');
  ...
  BrainForge.registerTopic({
    ...
    categories: [
      { id: 'mx-notation', sheetRef: 'schreibweise', title: 'Schreibweise', desc: 'Skalar, Vektor, Matrix erkennen', tier: 1, generate: genNotation },
      { id: 'mx-konzept', sheetRef: 'wb', title: 'Forward Pass verstehen', desc: 'Schicht als Funktion, W & b', tier: 1, generate: genConcept },
      { id: 'mx-vecact', sheetRef: 'schichtformel', title: 'Elementweise Aktivierung', desc: 'φ auf einen Vektor anwenden', tier: 1, weight: 1.2, generate: genVecAct },
      { id: 'mx-dimension', sheetRef: 'schichtformel', title: 'Dimensionen', desc: 'Wie groß sind W, b, z?', tier: 2, generate: genDim },
      { id: 'mx-zeile', sheetRef: 'rechnen', title: 'Matrixzeile rechnen', desc: 'z_j aus W·a + b bestimmen', tier: 2, weight: 1.3, generate: genRow },
      { id: 'mx-code', sheetRef: 'rechnen', title: 'Forward Pass im Code', desc: 'Python-Programm lesen & rechnen', tier: 2, generate: genCode },
      { id: 'mx-schicht', sheetRef: 'rechnen', title: 'Ganze Schicht rechnen', desc: 'z⁽¹⁾ = W a + b komplett', tier: 3, weight: 1.3, generate: genLayer },
      { id: 'mx-muster', sheetRef: 'wb', title: 'Zusammenhang erkennen', desc: 'Aus x/ŷ-Paaren die Funktion ablesen', tier: 3, generate: genPattern },
      { id: 'mx-funktion', sheetRef: 'wb', title: 'Funktion → Gewichte', desc: 'y = mx + c in W und b übersetzen', tier: 3, generate: genFn2W },
      { id: 'boss-matrix', sheetRef: 'rechnen', title: 'Boss: Schicht komplett', desc: 'W·x + b und ReLU, 4 Schritte', tier: 3, boss: true, generate: genBoss },
    ],
  });
})();
