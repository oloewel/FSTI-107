...
(function () {
  ...
  BrainForge.registerTopic({
    id: 'dl1',
    intro: "In diesem Kapitel lernst du den <b>Grundbaustein jedes neuronalen Netzes</b>: das künstliche Neuron.<br><br><b>Was wird behandelt?</b> Wie ein Neuron aus Eingaben, Gewichten und Bias eine Zahl macht (die Voraktivierung z), wie die Aktivierungsfunktion φ daraus die Ausgabe formt – und wie man Neuronen und Gewichte im Netz eindeutig benennt (w<sub>ji</sub><sup>(l)</sup>).<br><br><b>Wofür braucht man das?</b> Jedes noch so große Netz (ChatGPT, Bilderkennung, …) besteht nur aus Millionen dieser Bausteine. Wer <i>ein</i> Neuron sicher rechnen kann, kann im Prinzip jedes Netz rechnen – und genau das wird in der Klausur verlangt.",
    ...
    categories: [
      { id: 'ml-vs-dl', primer: {"what": "Bevor man Netze baut, muss man die Begriffe einordnen: Klassische Programmierung (Regeln vorgeben), Machine Learning (aus Daten + bekannten Ergebnissen lernen, aber Features von Hand) und Deep Learning (Netz lernt auch die Features selbst).", "why": "Der Unterschied erklärt, <b>warum</b> man überhaupt tiefe Netze benutzt: Man muss nicht mehr selbst überlegen, welche Merkmale wichtig sind. Außerdem eine typische Prüfungsfrage.", "ex": "Katzenbilder erkennen: Klassisches ML → ein Mensch definiert Merkmale wie „Kanten, Ohrenform, Fellfarbe“ und das Modell lernt nur deren Kombination. Deep Learning → das Netz bekommt die rohen Pixel und findet selbst heraus, worauf es achten muss."}, sheetRef: 'mldl', title: 'ML vs. Deep Learning', desc: 'Begriffe, Definitionen, Varianten der Datenverarbeitung', tier: 1, generate: () => genConcept(CONCEPTS_ML) },
      { id: 'symbole', primer: {"what": "Die „Vokabeln“ der Formelsprache: Was bedeuten a, b, z, φ, ŷ, Σ und die Zahlmengen ℕ und ℝ?", "why": "Ohne die Symbole kann man keine einzige Formel im Skript lesen – und in der Klausur wird genau diese Zuordnung abgefragt. Sie gehören auf dein Formelblatt!", "ex": "y vs. ŷ: y ist die <b>bekannte richtige Antwort</b> aus den Trainingsdaten („Maschine war wirklich kaputt: y = 1“). ŷ ist die <b>Schätzung des Modells</b> (z.B. ŷ = 0,83). Ziel: ŷ soll möglichst nah an y sein."}, sheetRef: 'symbols', title: 'Symbole & Formelsammlung', desc: 'a, b, z, φ, ŷ, Σ, ℕ, ℝ …', tier: 1, generate: genSymbol },
      { id: 'z-berechnen', primer: {"what": "Die Voraktivierung z ist das Herzstück jedes Neurons: jede Eingabe mal ihr Gewicht, alles addieren, Bias dazu.", "why": "Die Gewichte legen fest, wie stark (und in welche Richtung) jede Eingabe zählt – der Bias verschiebt, ab wann das Neuron reagiert. z fasst alle Eingaben in einer einzigen Zahl zusammen, mit der weitergerechnet wird.", "ex": "Maschinenüberwachung: Temperatur x₁ = 40 (Gewicht 0,1), Schwingung x₂ = 2 (Gewicht 2), Bias b = −5.<br><span class=\"formula\">z = 40·0,1 + 2·2 + (−5) = 4 + 4 − 5 = 3</span>"}, sheetRef: 'neuron', title: 'Voraktivierung z berechnen', desc: 'Gewichtete Summe + Bias', tier: 1, weight: 1.3, generate: genZ },
      { id: 'akt-anwenden', primer: {"what": "Die Aktivierungsfunktion φ verarbeitet die Voraktivierung z weiter zur Ausgabe: a = φ(z).", "why": "z kann jede beliebige Zahl sein (−87, 0,3, 512 …). Für eine Antwort wie „kaputt ja/nein“ oder „Wahrscheinlichkeit zwischen 0 und 1“ muss dieser Wert in die passende Form gebracht werden – genau das macht φ.", "ex": "z = −2 mit ReLU: φ(−2) = max(0, −2) = <b>0</b> – das Neuron bleibt „aus“. Dasselbe z mit Sigmoid: 1/(1+e²) ≈ <b>0,12</b> – als Wahrscheinlichkeit lesbar: „vermutlich nicht kaputt“."}, sheetRef: 'acts', title: 'Aktivierungsfunktion anwenden', desc: 'z gegeben → a = φ(z)', tier: 1, weight: 1.3, generate: genActApply },
      { id: 'akt-erkennen', primer: {"what": "Die vier Standard-Funktionen (Identität, Schwelle, ReLU, Sigmoid) am Graphen, an der Formel oder an der Beschreibung erkennen.", "why": "In Klausur und Praxis muss man auf einen Blick sehen: Begrenzt die Funktion auf 0…1? Schneidet sie Negatives ab? Gibt sie nur 0/1 aus? Danach wählt man die Funktion für die Aufgabe.", "ex": "S-förmige Kurve, die sich unten der 0 und oben der 1 annähert → <b>Sigmoid</b>. Knick bei 0, links flach auf 0, rechts Gerade → <b>ReLU</b>."}, sheetRef: 'acts', title: 'Aktivierungsfunktion erkennen', desc: 'Graph, Beschreibung oder Formel → Name', tier: 1, generate: genActIdentify },
      { id: 'neuron-konzepte', primer: {"what": "Verstehen statt rechnen: Was bewirken Gewichte, Bias und Aktivierungsfunktion im Neuron?", "why": "Wer nur den Rechenweg auswendig kann, scheitert an Verständnisfragen wie „Was bedeutet w = 0?“ – und genau solche Fragen standen im Skript und kommen gern in Prüfungen.", "ex": "w₂ = 0 → Eingabe x₂ hat <b>keinerlei Einfluss</b> (fällt aus der Summe). Negatives Gewicht → die Eingabe wirkt <b>hemmend</b>. Großer positiver Bias → das Neuron „feuert“ schon bei kleinen Eingaben."}, sheetRef: 'neuron', title: 'Neuron verstehen', desc: 'Bias, Gewichte, Voraktivierung, a vs. ŷ', tier: 2, generate: () => genConcept(CONCEPTS_NEURON) },
      { id: 'neuron-komplett', primer: {"what": "Der komplette Mini-Rechenweg eines Neurons in zwei Schritten: erst z (gewichtete Summe + Bias), dann a = φ(z).", "why": "Das ist der Grundbaustein schlechthin – jedes Netz ist nur eine Verkettung genau dieser Rechnung. Wer sie sicher kann, rechnet später ganze Netze fehlerfrei.", "ex": "x = (2 | 1), w = (1 | −1), b = 0, φ = ReLU:<br><span class=\"formula\">z = 2·1 + 1·(−1) + 0 = 1 → a = max(0, 1) = 1</span>"}, sheetRef: 'acts', title: 'Neuron komplett rechnen', desc: 'z berechnen und φ anwenden', tier: 2, weight: 1.3, generate: genNeuronFull },
      { id: 'notation-kante', primer: {"what": "Jede Verbindung im Netz eindeutig benennen: w<sub>ji</sub><sup>(l)</sup> – Schicht l, zu Neuron j, von Neuron/Eingang i.", "why": "Sobald mehrere Neuronen mehrere Eingaben teilen, reicht „w₁, w₂“ nicht mehr. Ohne eindeutige Namen kann man weder Formeln aufschreiben noch programmieren.", "ex": "Das Gewicht der Verbindung, die <b>in Schicht 2</b> ankommt, <b>zu Neuron 1</b> führt und <b>von Neuron 2</b> kommt, heißt w<sub>12</sub><sup>(2)</sup>. Merkregel: erst <b>wohin</b> (j), dann <b>woher</b> (i)."}, sheetRef: 'notation', title: 'Gewicht im Netz benennen', desc: 'Markierte Kante → w_ji^(l)', tier: 2, weight: 1.3, generate: genEdge },
      { id: 'notation-lesen', primer: {"what": "Die Indizes und Hochzahlen der Netz-Notation entschlüsseln: Was bedeuten l, j und i bei w, a, z und b?", "why": "Die Notation ist die „Adresse“ jedes Werts im Netz. Wer sie lesen kann, findet sich in jeder Formel zurecht – wer nicht, verwechselt Zeilen und Spalten und rechnet falsch.", "ex": "a<sub>2</sub><sup>(1)</sup> = die <b>Ausgabe von Neuron 2 in Schicht 1</b>. Sie wird zur Eingabe für die Neuronen der Schicht 2."}, sheetRef: 'notation', title: 'Notation lesen', desc: 'Was bedeuten l, j, i? a_j^(l)?', tier: 2, generate: genNotationRead },
      { id: 'formel-indizes', primer: {"what": "Die allgemeine Formel der Voraktivierung mit allen Indizes: z<sub>j</sub><sup>(l)</sup> = Σ w<sub>ji</sub><sup>(l)</sup>·a<sub>i</sub><sup>(l−1)</sup> + b<sub>j</sub><sup>(l)</sup> – und typische Fehler darin erkennen.", "why": "„Finde den Fehler in der Formel“ ist eine Standard-Klausuraufgabe. Wer die Logik versteht (Eingänge kommen aus Schicht l−1, Summe läuft bis n<sub>l−1</sub>), muss nichts stur auswendig lernen.", "ex": "Falsch: Σ w<sub>ji</sub><sup>(l)</sup>·a<sub>i</sub><sup>(l)</sup>. Warum? Die Eingaben stammen aus der <b>vorherigen</b> Schicht – richtig ist a<sub>i</sub><sup>(l−1)</sup>."}, sheetRef: 'notation', title: 'Formel mit Indizes', desc: 'z_j^(l) = Σ w_ji^(l) a_i^(l−1) + b_j^(l)', tier: 3, generate: genFormula },
      { id: 'schicht-rechnen', primer: {"what": "Mit der vollen Schicht-Notation ein konkretes Neuron in Schicht 2 durchrechnen – die Eingaben sind jetzt die a-Werte der Schicht 1, nicht mehr x.", "why": "Genau so rechnet man sich durch ein echtes Netz: Schicht für Schicht, immer mit den Ausgaben der Vorschicht. Das war die zentrale Übungsaufgabe im Skript.", "ex": "a₁⁽¹⁾ = 2, a₂⁽¹⁾ = 3, w₁₁⁽²⁾ = 0,5, w₁₂⁽²⁾ = −1, b₁⁽²⁾ = 0:<br><span class=\"formula\">z₁⁽²⁾ = 2·0,5 + 3·(−1) + 0 = −2</span> – dann noch φ anwenden."}, sheetRef: 'notation', title: 'Neuron in Schicht 2', desc: 'Mit Schicht-Notation rechnen (2 Schritte)', tier: 3, weight: 1.3, generate: genLayerCalc },
      { id: 'akt-vergleich', primer: {"what": "Ein und derselbe z-Wert durch alle vier Aktivierungsfunktionen – der direkte Vergleich.", "why": "So sieht man den Unterschied der Funktionen am deutlichsten und lernt die typischen Ausgaben auswendig – spart in der Klausur viel Zeit.", "ex": "Folien-Beispiel z = −2: Identität → <b>−2</b> · Schwelle → <b>0</b> · ReLU → <b>0</b> · Sigmoid → <b>≈ 0,12</b>."}, sheetRef: 'acts', title: 'Aktivierungen vergleichen', desc: 'Ein z, alle vier Funktionen', tier: 3, generate: genActCompare },
      { id: 'boss-kette', primer: {"what": "Zwei Neuronen hintereinander: Die Ausgabe des ersten ist die einzige Eingabe des zweiten – ein kompletter Forward Pass in Miniatur.", "why": "Das ist der Moment, in dem aus „einem Neuron“ ein <b>Netz</b> wird. Genau diese Aufgabe (Teil 1 + 2) stand im Skript – und sie ist die Blaupause für jede größere Rechnung.", "ex": "Neuron 1 liefert a₁⁽¹⁾ = 2. Neuron 2 mit w = 1,5 und b = −2: z = 2·1,5 − 2 = 1, Schwelle → ŷ = 1. Wichtig: Nie vergessen, nach jedem z auch φ anzuwenden!"}, sheetRef: 'notation', title: 'Boss: Neuronen-Kette', desc: 'Forward-Pass über zwei Neuronen (4 Schritte)', tier: 3, boss: true, generate: genChainBoss },
      { id: 'boss-netz', primer: {"what": "Der komplette Forward Pass durch ein kleines Netz (2 Eingaben → 2 Neuronen → 1 Ausgabeneuron): 6 Rechenschritte bis ŷ.", "why": "Die Königsdisziplin dieses Kapitels und realistische Klausuraufgabe: Wer hier sicher ist, beherrscht alles – Notation, z-Formel und Aktivierungsfunktionen.", "ex": "Reihenfolge: z₁⁽¹⁾ → a₁⁽¹⁾ → z₂⁽¹⁾ → a₂⁽¹⁾ (Schicht 1 fertig), dann z₁⁽²⁾ aus den beiden a-Werten → ŷ = φ(z₁⁽²⁾). Tipp: Zwischenergebnisse aufschreiben!"}, sheetRef: 'notation', title: 'Boss: Netz 2-2-1', desc: 'Kompletter Forward-Pass (6 Schritte)', tier: 3, boss: true, generate: genNetBoss },
    ],
  });
})();
