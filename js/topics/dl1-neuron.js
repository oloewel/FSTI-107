...
(function () {
  ...
  BrainForge.registerTopic({
    ...
    color: '#3df2c2',
    categories: [
      { id: 'ml-vs-dl', title: 'ML vs. Deep Learning', desc: 'Begriffe, Definitionen, Varianten der Datenverarbeitung', tier: 1, generate: () => genConcept(CONCEPTS_ML) },
      { id: 'symbole', title: 'Symbole & Formelsammlung', desc: 'a, b, z, φ, ŷ, Σ, ℕ, ℝ …', tier: 1, generate: genSymbol },
      { id: 'z-berechnen', title: 'Voraktivierung z berechnen', desc: 'Gewichtete Summe + Bias', tier: 1, weight: 1.3, generate: genZ },
      { id: 'akt-anwenden', title: 'Aktivierungsfunktion anwenden', desc: 'z gegeben → a = φ(z)', tier: 1, weight: 1.3, generate: genActApply },
      { id: 'akt-erkennen', title: 'Aktivierungsfunktion erkennen', desc: 'Graph, Beschreibung oder Formel → Name', tier: 1, generate: genActIdentify },
      { id: 'neuron-konzepte', title: 'Neuron verstehen', desc: 'Bias, Gewichte, Voraktivierung, a vs. ŷ', tier: 2, generate: () => genConcept(CONCEPTS_NEURON) },
      { id: 'neuron-komplett', title: 'Neuron komplett rechnen', desc: 'z berechnen und φ anwenden', tier: 2, weight: 1.3, generate: genNeuronFull },
      { id: 'notation-kante', title: 'Gewicht im Netz benennen', desc: 'Markierte Kante → w_ji^(l)', tier: 2, weight: 1.3, generate: genEdge },
      { id: 'notation-lesen', title: 'Notation lesen', desc: 'Was bedeuten l, j, i? a_j^(l)?', tier: 2, generate: genNotationRead },
      { id: 'formel-indizes', title: 'Formel mit Indizes', desc: 'z_j^(l) = Σ w_ji^(l) a_i^(l−1) + b_j^(l)', tier: 3, generate: genFormula },
      { id: 'schicht-rechnen', title: 'Neuron in Schicht 2', desc: 'Mit Schicht-Notation rechnen (2 Schritte)', tier: 3, weight: 1.3, generate: genLayerCalc },
      { id: 'akt-vergleich', title: 'Aktivierungen vergleichen', desc: 'Ein z, alle vier Funktionen', tier: 3, generate: genActCompare },
      { id: 'boss-kette', title: 'Boss: Neuronen-Kette', desc: 'Forward-Pass über zwei Neuronen (4 Schritte)', tier: 3, boss: true, generate: genChainBoss },
      { id: 'boss-netz', title: 'Boss: Netz 2-2-1', desc: 'Kompletter Forward-Pass (6 Schritte)', tier: 3, boss: true, generate: genNetBoss },
    ],
  });
})();
